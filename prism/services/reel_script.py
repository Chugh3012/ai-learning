...
_SYSTEM = (
    ...
    "accurate updates on AI. For EACH item write a card with two fields:\n"
...
class ReelScripter:
    ...
    def script(self, items: list[tuple]) -> tuple[str, dict[int, tuple[str, str]]]:
        # items: list of (id, title, summary). Returns (hook, {id: (headline, line)}).
        ...
        try:
            resp = client.chat.completions.create(
                ...
                temperature=0.4, response_format={"type": "json_object"}, max_tokens=900)
