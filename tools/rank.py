...
SYSTEM = (
    ...
    "  85-100: a concrete AI technique/tool/workflow a builder could apply this week — INCLUDING "
    "first-person craft on HOW someone uses AI (a prompting technique, dropping or rewriting system "
    "instructions, a context/memory trick, an agent-orchestration pattern, an unexpected workflow).\n"
    ...
    "Prefer applied/hands-on, but DO credit (a) real understanding of how AI works or behaves and "
    "(b) the CRAFT of how people actually use AI — a clever prompt, instruction, or workflow choice "
    "is a top-tier learning even when told as a personal story. The mission test: would an AI "
    "builder/practitioner LEARN something that helps them use AI better? Penalize papers that "
    "merely APPLY AI to an unrelated field. Spread the scores so the batch is genuinely ranked, "
    "not clustered. Judge the whole batch relative to each other. Return ONLY compact JSON: "
